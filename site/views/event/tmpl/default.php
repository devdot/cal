...
<div class="cal-event" itemscope itemtype="https://schema.org/Event">
	...
	<div class="cal-event-body row">
		<div class="cal-event-left col-md-6">
			...
			<?php endif; ?>
			<?php if($this->category->getParams()->get('link', 0)): ?>
			<a href="<?php echo JRoute::_('index.php?option=com_cal&view=category&id='.$this->item->catid); ?>" class="cal-event-category btn btn-default">Kategorie: <?php echo $this->item->category_title; ?></a>
			<?php endif; ?>
